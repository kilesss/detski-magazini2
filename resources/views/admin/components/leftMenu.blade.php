<div class="left-aside desktop-view">
    ...
    <div class="left-navigation">
        <ul class="list-accordion">
            ...
            <li><a href="{{ URL::to('admin/shops') }}" class="waves-effect"><span class="nav-icon">
                        <i class="fa fa-home"></i>
                    </span><span class="nav-label">Магазини</span></a>
            </li>
            <li><a href="{{ URL::to('admin/categories') }}" class="waves-effect"><span class="nav-icon">
                        <i class="fa fa-home"></i>
                    </span><span class="nav-label">Категории</span></a>
            </li>
            <li><a href="{{ URL::to('admin/products-categorised') }}" class="waves-effect"><span class="nav-icon">
                        <i class="fa fa-home"></i>
            ...
            <li><a href="{{ URL::to('admin/productParsing') }}" class="waves-effect"><span class="nav-icon">
                        <i class="fa fa-home"></i>
