            ...
            <div class="bg-bd">
                ...
                <div class="row top-speac">
                    <div class="col-xl-12 col-lg-12 col-md-6 col-12">
                        <div class="widget">
                            <div class="footer-lago"><a href="#"><img src="<?php echo e(asset('front/img/logo.png')); ?>"
                                                                      alt="logo.jpg')}}"/></a></div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-6 col-12">
                        <div class="payment payment-center">
                            <ul>
                                <li><a href="#"><img src="<?php echo e(asset('front/img/payment.png')); ?>" alt=""/></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<script src="<?php echo e(asset('front/js/vendor/jquery-migrate-3.3.0.min.js')); ?>"></script>
...
<!-- price-slider js
============================================ -->
<script src="<?php echo e(asset('front/js/price-slider.js')); ?>"></script>

<!-- jquery-meanmenu js -->
<script src="<?php echo e(asset('front/js/jquery.meanmenu.js')); ?>"></script>
...
<!-- Nivo slider js
============================================ -->
<script src="<?php echo e(asset('front/js/jquery.nivo.slider.js')); ?>"></script>

<!-- elevateZoom js
============================================ -->
<script src="<?php echo e(asset('front/js/jquery.elevateZoom-3.0.8.min.js')); ?>"></script>

<!-- jquery.bxslider.min.js
============================================ -->
<script src="<?php echo e(asset('front/js/jquery.bxslider.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp8.2\htdocs\detski-magazini\resources\views/components/footer.blade.php ENDPATH**/ ?>