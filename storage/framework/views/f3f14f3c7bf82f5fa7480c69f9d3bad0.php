...
<div class="page-container iconic-view">
                                            ...
                                            <div class="btn-toolbar" role="toolbar">
                                                <div class="btn-group" role="group">
                                                    <a href="#" class="btn btn-default btn-sm m-user-edit"
                                                       data-toggle="modal"
                                                       onclick="editShop(<?php echo e($shop->id); ?>)">Редактирай</a>
                        ...
                        <form method="post" id="formID" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12" style="padding-bottom: 22px; padding-top: 22px">
                                ...
                                <div class=" col-md-4" style="padding-left: 0px; padding-top: 19px;">
                                    <a href="<?php echo e(URL::to('admin/local-shops')); ?>" id="physical_shops" class="btn btn-success col-md-12">Физически
                                        магазини</a>
                                </div>
                                <div class=" col-md-4" style="padding-left: 0px; padding-top: 19px;">
                                    <a href="<?php echo e(URL::to('admin/local-shops')); ?>" id="categories" class="btn btn-success col-md-12">Категории</a>
                                </div>

                                <div class=" col-md-4" style="padding-left: 0px; padding-top: 19px;">
                                    <a href="<?php echo e(URL::to('admin/local-shops')); ?>" id="attributes" class="btn btn-success col-md-12">Атрибути</a>
                                </div>
    ...
    <script>
        ...
        function editShop(id) {
            $.ajax({
                type: "GET",
                url: "<?php echo e(Url::to('/')); ?>/admin/shops/" + id,
                cache: false,
                success: function (data) {
                    ...
                    $("#id_shop").val(id);
                    $("#physical_shops").attr("href", "<?php echo e(URL::to('admin/local-shops')); ?>/"+id)
                    $("#categories").attr("href", "<?php echo e(URL::to('admin/categories')); ?>/"+id)
                    $("#attributes").attr("href", "<?php echo e(URL::to('admin/attributes')); ?>/"+id)
...
<?php /**PATH C:\xampp\htdocs\detski-magazini\resources\views/admin/shops.blade.php ENDPATH**/ ?>