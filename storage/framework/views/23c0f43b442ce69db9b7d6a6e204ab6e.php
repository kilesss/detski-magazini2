...
">
                            ...
                            <input type="hidden" name="search" id="searchId" value="<?php echo e($search); ?>">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="single-product">
                                                <div class="product-image">
                                                    <a href="<?php echo e(route('product',$item->id)); ?>"><img src="<?php echo e($item->image_url); ?>" alt="" />
                                                    </a>
                                                </div>
                                                <div class="price-box">

                                                    <a href="<?php echo e(route('product',$item->id)); ?>"><p><?php echo e($item->title); ?></p></a>
                                                    <div class="price">
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination">
                                        <?php if($currentPage >=2): ?>
                                            <li class="page-item"><a class="page-link" href="<?php echo e(route('searching',[$search, $currentPage-1])); ?>">Предишна страница</a></li>

                                        <li class="page-item"><a class="page-link" href="<?php echo e(route('searching',[$search, $currentPage-1])); ?>"><?php echo e($currentPage-1); ?></a></li>
                                        <?php endif; ?>
                                        <li class="page-item"><a class="page-link" href="<?php echo e(route('searching',[$search, $currentPage])); ?>"><b><?php echo e($currentPage); ?></b></a></li>
                                            <?php if($currentPage<$lastPage): ?>
                                        <li class="page-item"><a class="page-link" href="<?php echo e(route('searching',[$search, $currentPage+1])); ?>"><?php echo e($currentPage+1); ?></a></li>
                                        <li class="page-item"><a class="page-link" href="<?php echo e(route('searching')); ?>/<?php echo e($search); ?>/<?php echo e($currentPage+1); ?>">Следваща страница</a></li>
                                            <?php endif; ?>
                                    </ul>
                                </nav>
                            </div>
...
<?php /**PATH /home/kulinarc/detski-magazini/resources/views/search.blade.php ENDPATH**/ ?>